...
func NewTagRepository(collectionName string) TagRepository {
	return &repo{
...
func (r *repo) FindOne(filter, projection bson.M) (entity.TagDB, error) {
	var banner entity.TagDB
...
func (r *repo) Find(filter, projection bson.M, limit, skip int) ([]entity.TagDB, error) {
	var banners []entity.TagDB
