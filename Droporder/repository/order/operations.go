...
func NewOrderRepository(collectionName string) OrderRepository {
	return &repo{
...
func (r *repo) FindOne(filter, projection bson.M) (entity.OrderDB, error) {
...
func (r *repo) FindWithIDs(filter, projection bson.M) ([]entity.OrderDB, error) {
	var orders []entity.OrderDB
