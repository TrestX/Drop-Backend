...
func (r *repo) FindOne(filter, projection bson.M) (entity.PaymentEntityDB, error) {
	var payment entity.PaymentEntityDB
...
func (r *repo) Find(filter, projection bson.M, limit, skip int) ([]entity.PaymentEntityDB, error) {
	var payments []entity.PaymentEntityDB
...
func (r *repo) FindWithIDs(filter, projection bson.M) ([]entity.PaymentEntityDB, error) {
	var payments []entity.PaymentEntityDB
